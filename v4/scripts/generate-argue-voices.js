...
const voices = [
  {
    openingText: '我奶哥敢吃屎。',
    text: '我峰哥也敢吃。',
    cue: '[defiant, competitive, emphatic, cute]',
    expectedDirection: '阿雅不服输地立刻接话，重读“我峰哥”和“也敢吃”，语气短促有冲劲。',
    output: '21-argue-feng-ge-also.mp3'
  },
  {
    openingText: '我奶哥敢吃三斤。',
    text: '我峰哥敢吃五斤。',
    cue: '[boastful, competitive, triumphant, cute]',
    expectedDirection: '阿雅带着夸耀和胜负欲回击，强调“五斤”，结尾笃定。',
    output: '22-argue-feng-ge-five-jin.mp3'
  }
];
    ...
    enabledState = await evaluate(
      ...
      `(async () => {
        ...
        return window.petAPI.saveSettings({
          ...
          idleIntervalSeconds: state.idleIntervalSeconds,
          actionEnabled: { ...state.actionEnabled, argue: true },
          fishVoiceModelId: state.fishVoiceModelId,
    ...
    `${JSON.stringify(
      {
        ...
        speaker: 'left/green-haired character (雅宝)',
        unvoicedSpeaker: 'right/red-dressed character',
        argueActionEnabled: Boolean(enabledState?.actionEnabled?.argue),
        voices: results
      },
      null,
      2
