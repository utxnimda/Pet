...
const LEGACY_FISH_VOICE_MODEL_ID = 'af09f6d5c47545b69dc8bb39d19ce0af';
...
function loadSettings() {
  ...
  try {
    ...
    const needsFishVoiceMigration =
      ...
      saved.fishVoiceModelId === LEGACY_FISH_VOICE_MODEL_ID;
    ...
    if (needsLocalVoiceMigration || needsFishVoiceMigration) {
      saveSettings();
    }
  } catch {
